view: annual_dollar_retention_cross_sales {
  view_label: "ADR - Cross-Sale Dollar Preservation"
  sql_table_name: "LEMONADE_DWH"."DATAMART_FINANCE"."SEPARATE_LOB_PRESERVATION" ;;

  dimension: separate_lob_preservation_id {
    hidden: yes
    primary_key: yes
    sql: ${TABLE}."SEPARATE_LOB_PRESERVATION_ID" ;;
  }
  ...
  dimension: line_of_business {
    ...
    type: string
    sql: CASE WHEN ${form} LIKE 'ho%' THEN 'ho'
          WHEN ${form} LIKE 'eu%' THEN 'eu'
          ELSE ${form} END;;
  }
